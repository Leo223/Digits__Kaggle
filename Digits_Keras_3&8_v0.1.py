...
# Obtenemos solo las filas de los 3 y los 8
data_filter = data [(data['label'] == 3) | (data['label'] == 8)]
...
model.save('Model_newNN_GPU_3&8_v7.0.h5')


# Epoch 60/60
# 1000/1000 [==============================] - 23s 23ms/step - loss: 1.7545e-05 - acc: 1.0000